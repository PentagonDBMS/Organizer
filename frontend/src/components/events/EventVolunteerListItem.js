...
const EventVolunteerListItem = ({ volunteer, onDelete, index }) => {
    ...
    return (
        <List.Item style={style}>
            <Modal
                ...
                dimmer='blurring'
            >
                <Modal.Header>Delete {volunteer.name}</Modal.Header>
                <Modal.Content>
                    <p>Are you sure you want to remove volunteering of {volunteer.name} from this event?</p>
            ...
            <Image avatar src={volunteer.isstudent ? studentImage : externalImage} size='tiny' />
            <List.Content>
                <List.Header as='a' onClick={() => navigate(`/students/${volunteer.students_or_externals_id}/details`)}>{volunteer.name}</List.Header>
                <List.Description>{volunteer.email}</List.Description>
            </List.Content>
        </List.Item>
    );
}

export default EventVolunteerListItem;
