...
import { Button, Icon, List, Image, Modal, Card, Label, ButtonGroup, Header } from 'semantic-ui-react';
import { useNavigate } from 'react-router-dom';
import { Link } from 'react-router-dom';
import { useEffect } from 'react';

const StudentParticipationListItem = ({ event, onDelete, index }) => {
    ...
    const handleDelete = () => {
        setOpen(false);
        onDelete(event.event_id, event.participation_id);
    };
    ...
    return (
        <Card centered style={style} className="event-item-animation">
            ...
            >
                ...
                <Modal.Content>
                    <p>Are you sure you want to remove participation of this participant from {event.name}?</p>
...
export default StudentParticipationListItem;